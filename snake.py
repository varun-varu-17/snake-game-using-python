...
cell_size = 25  # Reduced the cell size slightly to fit the screen
number_of_cell = 20  # Reduced the number of cells to make the game window smaller
OFFSET = 50  # Reduced the offset
...
class Food:
    ...
    def generate_random_cell(self):  # Corrected typo
...
class Game:
    ...
    def game_over(self):
        ...
        self.state = "stopped"
        self.score = 0
        print("Game Over!")  # You can add a game-over screen
...
# Adjusted screen size to better fit smaller display areas
...
while True:
    ...
    pygame.draw.rect(screen, DARK_GREEN, 
                     (OFFSET - 5, OFFSET - 5, cell_size * number_of_cell + 10, cell_size * number_of_cell + 10), 5)
    game.draw()
